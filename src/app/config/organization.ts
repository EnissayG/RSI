/** Coordonnées et faits publics RSI Propulsion (site officiel, 211 Grand Montréal). */
export const ORGANIZATION = {
  legalName: 'Regroupement de services intégrés Propulsion',
  shortName: 'RSI Propulsion',
  address: {
    street: '2075 rue Théodore',
    city: 'Montréal',
    province: 'Québec',
    postalCode: 'H1V 3C1',
    neighbourhood: 'Mercier, Hochelaga-Maisonneuve',
    full: '2075 rue Théodore, Montréal (Québec) H1V 3C1',
  },
  phone: '(514) 251-2525',
  phoneTel: 'tel:5142512525',
  ...
  mapLinkUrl: 'https://www.google.com/maps/search/?api=1&query=2075+rue+Théodore+Montréal+H1V+3C1',
  websiteOfficial: 'https://rsipropulsion.ca/',
  resource211: 'https://www.211qc.ca/organisme/regroupement-de-services-integres-propulsion-le-18763000',
} as const;
